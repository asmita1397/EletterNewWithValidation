                    ...
                    <div className="card" id="AFourPage" style={{ marginTop: '100px' }}>
                        <div className="card-body">
                            ...
                            <div>
                                ...
                                <p style={{ paddingLeft: 10, paddingRight: 10, textAlign: 'left' }}><strong>{this.state.employee.employeeName}</strong><strong>,</strong><div style={{wordBreak: 'break-word',width: '250px'}}>{this.state.employee.address}</div></p>
